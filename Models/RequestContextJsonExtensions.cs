...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="RequestContext"/> type
/// </summary>
public static class RequestContextJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="RequestContext"/> instance to a JSON string
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string into a <see cref="RequestContext"/> instance
    /// </summary>
    /// <param name="json">The JSON string to deserialize</param>
