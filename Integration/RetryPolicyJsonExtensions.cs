...
/// <summary>
/// Provides JSON serialization and deserialization extensions for <see cref="RetryPolicy"/>.
/// </summary>
public static class RetryPolicyJsonExtensions
{
	...
	/// </summary>
	/// <param name="value">The retry policy to serialize.</param>
	...
	/// <returns>A deserialized <see cref="RetryPolicy"/> instance, or null if the JSON is null or empty.</returns>
