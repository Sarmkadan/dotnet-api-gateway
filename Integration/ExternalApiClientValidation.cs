...
public static class ExternalApiClientValidation
{
    ...
    public static IReadOnlyList<string> Validate(this ExternalApiClient? value)
    {
        ...
        // Validate HttpClient (should not be null)
        if (value.GetHttpClient() is null)
        {
            problems.Add("HttpClient is null.");
        }

        // Validate RetryPolicy (should not be null)
        if (value.GetRetryPolicy() is null)
        {
            problems.Add("RetryPolicy is null.");
        }
    ...
    public static bool IsValid(this ExternalApiClient? value)
    {
    ...
    public static void EnsureValid(this ExternalApiClient? value)
    {
        ...
        if (problems.Count > 0)
        {
            throw new ArgumentException(
                $"ExternalApiClient is not valid. Problems: {string.Join(" ", problems)}");
        }
    }
