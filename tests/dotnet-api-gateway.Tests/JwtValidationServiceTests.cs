...
/// <summary>
/// Contains unit tests for the <see cref="JwtValidationService"/> class.
/// Tests JWT token validation, decoding, and various authentication policy scenarios.
/// </summary>
public sealed class JwtValidationServiceTests
{
	/// <summary>
	/// Test secret key used for generating JWT tokens during testing.
	/// </summary>
	private const string TestSecret = "my-very-long-secret-key-for-testing-purposes-at-least-32-chars";

	/// <summary>
	/// Test issuer value used for generating JWT tokens during testing.
	/// </summary>
	private const string TestIssuer = "test-issuer";

	/// <summary>
	/// Test audience value used for generating JWT tokens during testing.
	/// </summary>
	...
	/// </summary>
	/// <param name="secret">The secret key to use for signing the token.</param>
	/// <param name="issuer">The issuer claim value. Defaults to <see cref="TestIssuer"/>.</param>
	/// <param name="audience">The audience claim value. Defaults to <see cref="TestAudience"/>.</param>
	/// <param name="expiryMinutes">Number of minutes until token expiration. Defaults to 60.</param>
	/// <param name="notBeforeMinutes">Number of minutes until token becomes valid. Defaults to 0.</param>
