...
public class WebhookManagementControllerTests
{
    ...
    {
        _loggerMock.Object.LogInformation("Test {MethodName} started", nameof(CreateWebhookSubscription_InvalidRequest_ReturnsXmlWhenAcceptHeaderIsXml));
        ...
        _loggerMock.Object.LogInformation("Test {MethodName} completed", nameof(CreateWebhookSubscription_InvalidRequest_ReturnsXmlWhenAcceptHeaderIsXml));
    }
    ...
    {
        _loggerMock.Object.LogInformation("Test {MethodName} started", nameof(CreateWebhookSubscription_InvalidRequest_ReturnsJsonWhenNoAcceptHeader));
        ...
        _loggerMock.Object.LogInformation("Test {MethodName} completed", nameof(CreateWebhookSubscription_InvalidRequest_ReturnsJsonWhenNoAcceptHeader));
    }
}